...
class PsuUtil(PsuBase):
    ...
    IPMI_PSU1_DATA = "ipmitool raw 0x04 0x2d 0x40 |  awk '{print substr($0,9,1)}'"
    IPMI_PSU2_DATA = "ipmitool raw 0x04 0x2d 0x30 |  awk '{print substr($0,9,1)}'"
