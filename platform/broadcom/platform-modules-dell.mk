# Dell S6000,Z9100, S6100, Z9264F , S5232F,Z9332F, Z9664F Platform modules
...
DELL_Z9864F_PLATFORM_MODULE_VERSION= 1.1
...
DELL_Z9864F_PLATFORM_MODULE = platform-modules-z9864f_$(DELL_Z9864F_PLATFORM_MODULE_VERSION)_amd64.deb
$(DELL_Z9864F_PLATFORM_MODULE)_PLATFORM = x86_64-dell_z9864f-r0
$(eval $(call add_extra_package,$(DELL_Z9100_PLATFORM_MODULE),$(DELL_Z9864F_PLATFORM_MODULE)))
