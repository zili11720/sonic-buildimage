#!/usr/bin/python3
"""
# Module on Z9864F, the BaseBoard Management Controller is an
...
def _print_temperature_sensors():
    ...
    print('   INLET Left Temp:          ',\
        (_get_bmc_register('ILET_Left_temp')))
    print('   INLET Right Temp:         ',\
        (_get_bmc_register('ILET_Right_temp')))
    print('   OUTLET Left Temp:         ',\
        (_get_bmc_register('OLET_Left_temp')))
    print('   OUTLET Right Temp:        ',\
        (_get_bmc_register('OLET_Right_temp')))
    print('   OSFP Rear Temp:           ',\
        (_get_bmc_register('OSFP_Rear_temp')))
    print('   CPUCD Front Temp:         ',\
        (_get_bmc_register('CPUCD_Front_temp')))
    print('   PSU1 AF Temp:             ',\
...
for tray in range(1, Z9864F_MAX_FAN_TRAYS + 1):
...
print('\nPSUs:')
for psu in range(1, Z9864F_MAX_PSUS + 1):
