...
class Watchdog(WatchdogBase):
    ...
    def _get_cpld_register(reg_name):
        ...
        try:
            with open(cpld_reg_file, 'r') as file_des:
                ret_val = file_des.read()
        except IOError:
            return 'ERR'
    ...
    def _set_cpld_register(reg_name, value):
        ...
        try:
            with open(cpld_reg_file, 'w') as file_des:
                ret_val = file_des.write(str(value))
        except IOError:
            ret_val = 'ERR'
    ...
    def _get_time(self):
        ...
        """
        t_spec = _timespec()
        if self._clock_gettime(self.CLOCK_MONOTONIC, ctypes.pointer(t_spec)) != 0:
    ...
    def get_remaining_time(self):
        ...
        Returns:
            ...
            S3248T doesnot have hardware support to show remaining time.
