...
try:
    ...
    for line in output:
        if line.startswith('emc'):
            found_emc = True
            with open('/sys/devices/platform/dell-s3248t-cpld.0/fan0_prs') as f:
                line = f.readline()
            present = int(line, 0)
            if present:
                print('\t' + 'Fan Tray 1:')
                ...
                with open('/sys/devices/platform/dell-s3248t-cpld.0/fan0_dir') as f:
                    line = f.readline()
            ...
            with open('/sys/devices/platform/dell-s3248t-cpld.0/fan1_prs') as f:
                line = f.readline()
            present = int(line, 0)
            if present:
                print('\t' + 'Fan Tray 2:')
                ...
                with open('/sys/devices/platform/dell-s3248t-cpld.0/fan1_dir') as f:
                    line = f.readline()
                direction = 'Intake' if line[:-1] == 'B2F' else 'Exhaust'
                print('\t\t' + 'Airflow:\t' + direction)
            else:
            ...
            with open('/sys/devices/platform/dell-s3248t-cpld.0/fan2_prs') as f:
                line = f.readline()
            present = int(line, 0)
            if present:
                print('\t' + 'Fan Tray 3:')
                ...
                with open('/sys/devices/platform/dell-s3248t-cpld.0/fan2_dir') as f:
                    line = f.readline()
                direction = 'Intake' if line[:-1] == 'B2F' else 'Exhaust'
                print('\t\t' + 'Airflow:\t' + direction)
            else:
    ...
    print('\nPSUs:')
    idx = 0
    with open('/sys/devices/platform/dell-s3248t-cpld.0/psu0_prs') as f:
        line = f.readline()
    ...
    if not found_psu1:
        ...
        for line in output:
            if line.startswith('dps460-i2c-10'):
                with open('/sys/devices/platform/dell-s3248t-cpld.0/psu0_status') as f:
                    line = f.readline()
                status = int(line, 0)
                if not status:
                    print('\tPSU1:\tNot OK')
            ...
            idx += 1
    idx = 0
    with open('/sys/devices/platform/dell-s3248t-cpld.0/psu1_prs') as f:
        line = f.readline()
    ...
    if not found_psu2:
        ...
        for line in output:
            if line.startswith('dps460-i2c-11'):
                with open('/sys/devices/platform/dell-s3248t-cpld.0/psu1_status') as f:
                    line = f.readline()
                status = int(line, 0)
                if not status:
                    print('\tPSU2:\tNot OK')
