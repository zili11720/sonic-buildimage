...
class Thermal(ThermalBase):
    ...
    def __init__(self, thermal_index):
        ...
        thermal_list = [\
            ...
            ('Switch_Temp_U1',  '0x03', 'ASIC External Front Temp'),\
            ('Switch_Temp_U18', '0x04', 'ASIC External Rear Temp'),\
            ('Switch_Temp_U28', '0x05', 'Switchboard Right Temp'),\
            ('Switch_Temp_U29', '0x06', 'Switchboard Left Temp'),\
