...
class Component():
    ...
    def __init__(self, component_index):
        COMPONENT_LIST = [
            ...
            ("CPLD SW1",  "CPLD for port control QSFP(1-16)", self.__get_cpld_ver),
            ("CPLD SW2",  "CPLD for port control QSFP(17-32) SFP(33)", self.__get_cpld_ver),
