...
{
  return ( FD_CNFGR_AUTHMGR_DEFAULT_STACK_SIZE );
}
...
{
  return ( FD_CNFGR_AUTHMGR_DEFAULT_TASK_SLICE );
}
...
{
  return ( FD_CNFGR_AUTHMGR_DEFAULT_TASK_PRI );
}
